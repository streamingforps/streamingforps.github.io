...
document.addEventListener("DOMContentLoaded", () => {
  ...
  renderCampaignHero();
  renderGoals(document.querySelector("[data-render='goals']"));
...
function renderGoals(container) {
  ...
  goals.forEach((goal) => {
    ...
    card.innerHTML = `
      ...
      <div class="progress-track" role="progressbar" aria-valuenow="${percent}" aria-valuemin="0" aria-valuemax="100" aria-label="${goal.label} progress">
